...
The `wondo-interactive-fiction` skill produces this file at `stories/<slug>/brief.md` as Phase 9 of its flow (after the 8 gates pass). The user reviews and edits before invoking the pixellab pipeline. Numeric prefixes (`01`, `02`, …) become file prefixes inside `01-cover/`, `02-cast/`, etc.
